...
// 	});
//
// 	it('renders with assigned, due, assignmentItems', () => {
// 		let fixture = TestBed.createComponent(TestApp);
// 		fixture.detectChanges();
//
// 		let assignmentActivityDebugElement = fixture.debugElement.query(By.css('#assigned_due_assignmentItems'));
...
// 								id="assigned_due_assignmentItemss">
